      ...
      <div class="offset-lg-3 offset-md-2 col-lg-6 col-md-8 col-12">
        <div class="mb-3">
          ...
          <select
            class="form-select"
            name="kategoriaId"
            v-model="ujHirdetes.kategoriaId"
          >
        ...
        <div class="mb-3">
          ...
          <input
            ...
            class="form-control"
            name="hirdetesDatuma"
            v-model="ujHirdetes.hirdetesDatuma"
            readonly
          />
        </div>
        <div class="mb-3">
        ...
        <div class="form-check mb-3">
          <input
            ...
            type="checkbox"
            name="tehermentes"
            v-model="ujHirdetes.tehermentes"
            checked
          />
        ...
        <div class="alert alert-danger alert-dismissible" role="alert">
          <strong>{{ error }}</strong>
          <button type="button" class="btn-close" @click="bezar"></button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    save() {
      Axios.post("/api/ujingatlan", this.ujHirdetes)
        .then((response) => {
